...
The **Account Manually** option allows you to generate an API token from your Instagram business account and use it to connect your business account with WP Social Ninja.

![configure instagram 0](/guide/public/images/social-feeds/instagram-configuration-social-feeds-wp-social-ninja/instagram-configuration-2.webp)
...
![configure instagram 2](/guide/public/images/social-feeds/instagram-configuration-social-feeds-wp-social-ninja/instagram-configuration-3.webp)
...
![configure instagram 3](/guide/public/images/social-feeds/instagram-configuration-social-feeds-wp-social-ninja/instagram-configuration-4.webp)
...
![configure instagram 5](/guide/public/images/social-feeds/instagram-configuration-social-feeds-wp-social-ninja/instagram-configuration-6.webp)
...
![configure instagram 7](/guide/public/images/social-feeds/instagram-configuration-social-feeds-wp-social-ninja/instagram-configuration-8.webp)
...
![configure instagram 8](/guide/public/images/social-feeds/instagram-configuration-social-feeds-wp-social-ninja/instagram-configuration-12.webp)

Next, you'll be asked to grant the necessary permissions. Click the **Allow** button to proceed.

![configure instagram 9](/guide/public/images/social-feeds/instagram-configuration-social-feeds-wp-social-ninja/instagram-configuration-4.webp)

Once you've granted the permissions, you'll receive your **Access Token** and **User ID**. Be sure to copy them for later use.

![configure instagram 10](/guide/public/images/social-feeds/instagram-configuration-social-feeds-wp-social-ninja/instagram-configuration-13.webp)
...
![configure instagram 11](/guide/public/images/social-feeds/instagram-configuration-social-feeds-wp-social-ninja/instagram-configuration-11.webp)
