...
Let's follow the simple article to learn how to use hashtags for your Instagram Posts.

- To do so, first, go to **Settings (from the admin dashboard) →  Shoppable by Hashtags→Add your first shoppable hashtag** button.

- Click on the **Add your first shoppable hashtag** button to add your hashtags.

![Shoppable by Hashtags](/guide/public/images/social-feeds/shoppable-by-hashtags-social-feeds-wp-social-ninja/image.png)
...
![Add Shoppable Hashtag](/guide/public/images/social-feeds/shoppable-by-hashtags-social-feeds-wp-social-ninja/add-shoppable-hashtag.png)
...
![Instagram Feed](/guide/public/images/social-feeds/shoppable-by-hashtags-social-feeds-wp-social-ninja/instagram-feed.png)

_Instagram Feed_

- You will be taken to the page you previously selected when you click the **Buy Now** button.

![Redirected Page](/guide/public/images/social-feeds/shoppable-by-hashtags-social-feeds-wp-social-ninja/redirected-page.png)
...
![Turn off Include Shoppable by Hashtags option](/guide/public/images/social-feeds/shoppable-by-hashtags-social-feeds-wp-social-ninja/turn-off-include-shoppable-by-hashtags-option.png)

_Turn off Include Shoppable by Hashtags option_

This is how you can utilize **Shoppable Hashtags** on Instagram by following those simple steps!
