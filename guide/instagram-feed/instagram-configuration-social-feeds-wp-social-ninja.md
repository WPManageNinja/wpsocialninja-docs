...
![configure instagram 1](/guide/public/images/instagram-feed/instagram-configuration-social-feeds-wp-social-ninja/Configure-Instagram-1-scaled-2.webp)
...
The **Manually Connect Your Account** option allows you to generate an API token from your Instagram business account and use it to connect your business account with WP Social Ninja.

![configure instagram 0](/guide/public/images/instagram-feed/instagram-configuration-social-feeds-wp-social-ninja/Configure-Instagram-0-scaled-2.webp)
...
![configure instagram 2](/guide/public/images/instagram-feed/instagram-configuration-social-feeds-wp-social-ninja/Configure-Instagram-2-scaled-2.webp)
...
![configure instagram 3](/guide/public/images/instagram-feed/instagram-configuration-social-feeds-wp-social-ninja/Configure-Instagram-3-2.webp)

Once connected, your **Instagram Business Account** will be added to **WP Social Ninja**.

- To add another account, click the **Add More Account** button.

- To create or modify your **Instagram Platform Template**, click the **Add New Template** button.

![configure instagram 4](/guide/public/images/instagram-feed/instagram-configuration-social-feeds-wp-social-ninja/Configure-Instagram-4-scaled-2.webp)
...
![configure instagram 5](/guide/public/images/instagram-feed/instagram-configuration-social-feeds-wp-social-ninja/Configure-Instagram-5-scaled-2.webp)
...
![configure instagram 6](/guide/public/images/instagram-feed/instagram-configuration-social-feeds-wp-social-ninja/Configure-Instagram-6-2.webp)
...
![configure instagram 7](/guide/public/images/instagram-feed/instagram-configuration-social-feeds-wp-social-ninja/Configure-Instagram-7-scaled-2.webp)
...
![configure instagram 8](/guide/public/images/instagram-feed/instagram-configuration-social-feeds-wp-social-ninja/Configure-Instagram-8-scaled-2.webp)

Next, you'll be asked to grant the necessary permissions. Click the **Allow** button to proceed.

![configure instagram 9](/guide/public/images/instagram-feed/instagram-configuration-social-feeds-wp-social-ninja/Configure-Instagram-9-2.webp)

Once you've granted the permissions, you'll receive your **Access Token** and **User ID**. Be sure to copy them for later use.

![configure instagram 10](/guide/public/images/instagram-feed/instagram-configuration-social-feeds-wp-social-ninja/Configure-Instagram-10-scaled-2.webp)
...
![configure instagram 11](/guide/public/images/instagram-feed/instagram-configuration-social-feeds-wp-social-ninja/Configure-Instagram-11-scaled-2.webp)

Your account will now be successfully connected to **WP Social Ninja**. To add another account, click the **Add More Account** button. If you want to create or modify your **Instagram Platform Template**, click the **Add New Template** button.

![configure instagram 12](/guide/public/images/instagram-feed/instagram-configuration-social-feeds-wp-social-ninja/Configure-Instagram-12-scaled-2.webp)
