...
[!Tip] 
>If you want a faster setup, you can also use the **[Quick Builder](/guide/getting-started/onboarding-setup-wizard)** feature to open a simple 3-step wizard that helps you create a professional-looking template in seconds.
