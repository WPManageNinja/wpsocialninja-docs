...
These settings control the appearance of your Instagram Username (e.g., `@wpsocialninja`) in the header.
...
![Instagram Styling & Connection](/guide/public/images/social-feeds/instagram-feed-template-styling-connection/instagram-template-styling-1.webp)

### 2. Content

This section styles the text caption (the description) that appears with each individual post in your feed.

* **Hashtag Color:** This is a special setting that controls the color of any clickable `#hashtags` inside your post's caption. This helps them stand out from the rest of the text.
...
![Instagram Styling & Connection](/guide/public/images/social-feeds/instagram-feed-template-styling-connection/instagram-template-styling-2.webp)
...
![Instagram Styling & Connection](/guide/public/images/social-feeds/instagram-feed-template-styling-connection/instagram-template-styling-3.webp)
...
![Instagram Styling & Connection](/guide/public/images/social-feeds/instagram-feed-template-styling-connection/instagram-template-styling-4.webp)
